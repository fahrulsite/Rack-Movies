package com.fahrul.rackmovies.notif
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        private const val notifReminder = "daily_reminder"
        private const val notifRelease = "daily_release"
        private const val TAG = "AlarmReceiver"

        const val idReminder = 100
        const val idRelease = 200
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (intent.action) {
            notifReminder -> {
                ...
                showNotification(context, title, message, idReminder, null)
            }
    ...
    fun setAlarm(context: Context, timeInMillis: Long, alarmId: Int) {
        ...
        intent.action = if (alarmId == idReminder) {
            notifReminder
        } else {
            notifRelease
        }
